...
export const getLikedPosts = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ message: "Something went wrong in getLikedPosts Controller" });
  }
};
...
export const getFollowingPosts = async (req, res) => {
  try {
    ...
    console.log(error);
    res.status(500).json({
      message: "Something went wrong in getFollowingPosts Controller",
    });
  }
};
...
export const getUserPosts = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Something went wrong in getUserPosts Controller" });
  }
};
